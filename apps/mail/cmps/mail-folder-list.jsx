    ...
    return <section className="mail-folder-list">
        ...
        <div className="folders-container">
            <div onClick={() => navigate('/mail/inbox')} className={`folder ${folder === 'inbox' && 'active'}`}>
                <div className="folder-list-icon"><object data="../../..//assets/icons/inbox-full.svg" width="15" height="15"></object></div>
            ...
            <div onClick={() => navigate('/mail/sent')} className={`folder ${folder === 'sent' && 'active'}`}>
                <div className="folder-list-icon"><object data="../../..//assets/icons/sent.svg" width="15" height="15"></object></div>
            ...
            <div onClick={() => navigate('/mail/trash')} className={`folder ${folder === 'trash' && 'active'}`}>
                <div className="folder-list-icon"><object data="../../..//assets/icons/trash.svg" width="15" height="15"></object></div>
            ...
            <div onClick={() => navigate('/mail/draft')} className={`folder ${folder === 'draft' && 'active'}`}>
                <div className="folder-list-icon"><object data="../../..//assets/icons/draft.svg" width="15" height="15"></object></div>
